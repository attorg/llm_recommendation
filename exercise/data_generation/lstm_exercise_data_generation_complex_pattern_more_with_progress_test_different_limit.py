...
for _ in range(num_sequences):
    ...
    main_progress = np.linspace(0, 1, 10)  # 9 esercizi nella fase main
    for i in range(9):
    ...
    cool_down_progress = np.linspace(0, 1, 4)  # 3 esercizi nella fase cool-down
    for i in range(3):
...
output_file_path = "../data/exercise_sequence_complex_pattern_more_with_progress_test_different_limit.csv"
